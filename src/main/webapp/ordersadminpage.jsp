...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form name="custordersadmin" action="FrontController" method="POST">
                <input type="hidden" name="command" value="custordersadmin">
            
               <input type="submit" value="Se kundens ordrer" name="custordersadmin"></a>
